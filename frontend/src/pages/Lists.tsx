...
function ListCard({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className={`group relative rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-100 transition-all duration-150 ${
      ...
      >
        <div className="flex items-start justify-between">
          <div className="relative">
            ...
            {pressing && (
              <svg
                className="absolute -left-1 -top-1 h-[52px] w-[52px] -rotate-90"
                viewBox="0 0 40 40"
              >
                <circle
                  cx="20"
          ...
          <div className="flex items-center gap-1.5">
            {list.pinned && (
              <Pin className="h-3.5 w-3.5 fill-emerald-500 text-emerald-500" />
            )}
...
function ListCardOverlay({ list }: { list: ShoppingList }) {
  ...
  return (
    <div className="w-full rounded-2xl bg-white p-5 shadow-2xl ring-2 ring-emerald-400">
      <div className="flex items-start justify-between">
        <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-emerald-100 text-xl">
          {LIST_TYPE_ICON[listType]}
        </div>
